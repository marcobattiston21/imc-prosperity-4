...
# -- TOMATOES -------------------------------------------------------------------
# We are doing the exact same thing as EMERALDS, but the fv is set to the mid point between best ask and best bid
class TomatoesTrader(ProductTrader):
    ...
    def get_orders(self) -> dict:
        ...
        # We compute the fair value as the mean between the highest vol bid and highest vol ask
        fv = (self.best_bid + self.best_ask) / 2
